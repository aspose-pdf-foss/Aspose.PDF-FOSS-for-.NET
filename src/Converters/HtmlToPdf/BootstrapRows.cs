...
internal static partial class HtmlToPdfConverter
{
        ...
        double pageWidth, double pageHeight)
    {
        ...
        var invc = System.Globalization.CultureInfo.InvariantCulture;
        var grey = Color.FromRgbBytes(0x59, 0x59, 0x59);
        var red = Color.FromRgbBytes(0xCF, 0x31, 0x35);
        ...
        Line(SaBodyX, pageWidth - SaBodyX, SaHrY2, 0.75, Color.FromRgbBytes(0x55, 0x55, 0x55));
