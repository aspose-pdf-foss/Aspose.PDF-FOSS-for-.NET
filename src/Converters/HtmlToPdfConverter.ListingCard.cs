...
// a floated inline-SVG icon per row). The reference draws the card on SYMMETRIC
...
{
    // The reference's card placement: symmetric 96 pt side margins, the card one
        ...
        double pageWidth, double pageHeight)
    {
        ...
        var borderCol = ParseCssColor(borderV) ?? Color.FromRgb(149, 151, 153);
        ...
        var headerFs = 16.5;
        Color headerBg = Color.FromRgb(228, 228, 228);
        ...
        var evenBg = Color.FromRgb(240, 240, 240);              // .item:nth-child(even)
        var oddBg = Color.FromRgb(252, 252, 252);               // .item:nth-child(odd)
