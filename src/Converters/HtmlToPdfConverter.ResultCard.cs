...
internal static partial class HtmlToPdfConverter
{
    ...
    //
    // Geometry (all measured on the reference):
        ...
        double pageHeight)
    {
        ...
        var boxCol = ParseCssColor(boxM.Groups[3].Value) ?? Color.FromRgb(226, 232, 237);
        ...
        foreach (var (label, value) in rows)
        {
            ...
            HLine(tableX, tableX + labelBoxW, rowBot, Color.FromRgb(255, 255, 255));
            HLine(tableX + labelBoxW, tableX + innerW, rowBot, Color.FromRgb(255, 255, 255));
            rowTop = rowBot;
        }
        y += boxH;
        ...
        if (footerAlt.Success)
        {
            ...
            HLine(96.0, 96.0 + contentW, y + RcBrokenImgBaselinePt + 3.83, Color.FromRgb(255, 255, 255));
        }
