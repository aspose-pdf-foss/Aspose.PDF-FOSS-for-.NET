...
// bare divs (the VARER headline). The reference lays it on SYMMETRIC 96 pt side
...
// the stylesheet are measured on the reference render.
internal static partial class HtmlToPdfConverter
{
        ...
        double pageWidth, double pageHeight)
    {
        ...
        // DK-8900), and NBSP survives the collapse (the reference draws the
