...
internal static partial class HtmlToPdfConverter
{
    ...
    private static readonly Color VrPageBg = Color.FromRgb(0xF2, 0xF5, 0xF7);
    private static readonly Color VrWhite = Color.FromRgb(0xFF, 0xFF, 0xFF);
    private static readonly Color VrFrameBorder = Color.FromRgb(0xE2, 0xE2, 0xE2);
    private static readonly Color VrRuleBorder = Color.FromRgb(0xCE, 0xD2, 0xD3);
    private static readonly Color VrBarBorder = Color.FromRgb(0xEC, 0xEC, 0xEC);
    private static readonly Color VrBand = Color.FromRgb(0xEE, 0xEE, 0xEE);
    private static readonly Color VrBrand = Color.FromRgb(0x23, 0x67, 0xAB);
    private static readonly Color VrInk = Color.FromRgb(0x66, 0x66, 0x66);
    private static readonly Color VrDarkInk = Color.FromRgb(0x33, 0x33, 0x33);
    private static readonly Color VrLinkInk = Color.FromRgb(0x2A, 0x7F, 0xDA);
    private static readonly Color VrErrorInk = Color.FromRgb(0xDE, 0x29, 0x29);
    private static readonly Color VrBannerInk = Color.FromRgb(0xF6, 0xF5, 0xF4);
    ...
    {
        public Color Bubble = Color.FromRgb(0x99, 0xCC, 0x33);
        public string Title = "";
    ...
    {
        public string Name = "";
        public Color Bubble = Color.FromRgb(0xDE, 0x29, 0x29);
    ...
    private static Color VrBubbleColor(string tag)
    {
        var st = Regex.Match(tag, @"background(?:-color)?\s*:\s*#([0-9a-f]{6})",
            RegexOptions.IgnoreCase);
        if (st.Success)
            return Color.FromRgb(System.Convert.ToInt32(st.Groups[1].Value[..2], 16),
        ...
        if (tag.Contains("pass", StringComparison.OrdinalIgnoreCase))
            return Color.FromRgb(0x99, 0xCC, 0x33);
        if (tag.Contains("syserror", StringComparison.OrdinalIgnoreCase))
            return Color.FromRgb(0xC1, 0x3E, 0xB3);
        if (tag.Contains("info", StringComparison.OrdinalIgnoreCase))
            return Color.FromRgb(0x00, 0x7F, 0xFF);
        if (tag.Contains("low", StringComparison.OrdinalIgnoreCase))
            return Color.FromRgb(0xF5, 0xCC, 0x00);
        return Color.FromRgb(0xDE, 0x29, 0x29);
    }
