...
internal static class CffStandardStrings
{
    ...
    private static readonly string[] _names =
    {
        ...
        "oslash", "oe", "germandbls", "onesuperior", "twosuperior",
        "threesuperior", "minus", "multiply", "onesuperior",
        "twosuperior", "threesuperior", "Idieresis", "Eacute",
        "Ecircumflex", "Egrave", "Iacute", "Icircumflex", "Igrave",
        "Ntilde", "Oacute", "Ocircumflex", "Ograve", "Otilde", "Scaron",
        "Uacute", "Ucircumflex", "Ugrave", "Yacute", "Ydieresis",
        ...
        "exclamdownsmall", "centinferior", "lira", "centoldstyle",
        "florinsmall", "Macronsmall", "questiondownsmall", "onequarter",
        "onehalf", "threequarters", "questionsuperior",
        "questiondownsuperior", "eight", "asuperior", "centsuperior",
        "commasuperior", "dollarinferior", "dollaroldstyle",
        "dollarsuperior", "hypheninferior", "periodinferior",
        ...
        "Black", "Bold", "Book", "Light", "Medium", "Regular", "Roman",
        "Semibold"
    };
}
